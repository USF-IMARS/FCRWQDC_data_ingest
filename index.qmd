...
```{R, show percent missing station IDs}
...
```{R, show percent missing date}
#| code-summary: show percent of missing date
library(dplyr)
library(scales)
# show percentage of missing or na rows in df$Monitoring.Location.ID grouped by df$program
# 1. Get the total number of rows for each program
...
```{R, show percent missing value}
#| code-summary: show percent of missing value
library(dplyr)
library(scales)
# show percentage of missing or na rows in df$Monitoring.Location.ID grouped by df$program
# 1. Get the total number of rows for each program
