...
df <- getData(here(glue("data/_WIN_WAVES_OTIS_{params$org_id}.txt")))
...
leaflet(df_unique_locs) %>%
  ...
  addCircleMarkers(
    ...
    fillOpacity = 0.5,
    popup       = ~paste0(
      "Organization: ", Organization.ID, "<br>",
...
[Download Data For This Provider](`{r} glue("../data/_WIN_WAVES_OTIS_{params$org_id}.txt")`)