...
samples_df <- df %>%
  ...
  mutate(
    analyte = case_when(
      ...
      original.analyte.name == "Nitrogen-_Total_Kjeldahl" ~ "Total_Nitrogen",
      original.analyte.name == "Nitrogen__Kjeldahl__Total" ~ "Total_Nitrogen",
      original.analyte.name == "Total_Kjeldahl_Nitrogen" ~ "Total_Nitrogen",
