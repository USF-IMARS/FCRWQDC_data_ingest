...
```{R, Show number of records per unit}
#| code-summary: Show number of records per unit

library(ggplot2)
ggplot(df, aes(x = units)) +
  geom_bar() +
  labs(title = "Reported units", x = "unit", y = "Count") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

### Reporting Programs:
```{R, Show number of records per program}
#| code-summary: Show number of records per program
